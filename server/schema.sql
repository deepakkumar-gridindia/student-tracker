-- ─── Bluebells International – Student Tracker DB ────────────────────────────
CREATE DATABASE IF NOT EXISTS student_tracker CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE student_tracker;
...
CREATE TABLE IF NOT EXISTS students (
  ...
  math_score      INT DEFAULT 85,
  science_score   INT DEFAULT 85,
  english_score   INT DEFAULT 85,
  hindi_score     INT DEFAULT 85,
  avg_score       INT DEFAULT 85
);
...
-- ─── Seed Data ────────────────────────────────────────────────────────────────
INSERT IGNORE INTO schools VALUES
...
INSERT IGNORE INTO students (id, name, roll_no, class_id, school_id, parent_id) VALUES
...
INSERT IGNORE INTO parents (id, name, student_id, phone, password) VALUES
